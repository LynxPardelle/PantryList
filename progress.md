...
| Replenishment design spec | `docs/superpowers/specs/2026-04-29-replenishment-intelligence-guided-ux-design.md` | Capture the approved hybrid approach plus safe archive/delete flows before implementation planning | Draft spec written and self-reviewed; awaiting user review before implementation plan | ✓ |
